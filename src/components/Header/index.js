                    ...
                    <div className={'hidden bg-white w-full h-[6rem] lg:flex relative z-20 '}>
                        <div className='container px-[6rem] h-full flex items-center justify-between'>
                            <div className=' flex cursor-pointer'>
                                <Link to='/' className=''>
                                    <div className='w-[16rem] lg:w-[18rem] h-full p-2 mr-[2rem] rounded-2xl'>
                            ...
                            <div className='flex ml-[6rem]'>
                                ...
                                <div >
                                    <div className='text-slate-600 font-bold text-sm'> +49 69 71719191 </div>
                                    <div className='text-slate-500 text-sm'>Nachtnebeltrust@support.com</div>
                                </div>
                            </div>
                            <div className='flex mr-[4rem] whitespace-nowrap'>
                                ...
                                <div>
                                    <div className='text-slate-600 font-bold text-sm'>Breite Str</div>
                                    <div className='text-slate-500 text-sm'> Breite Str. 34, 40213 Düsseldorf, Germany</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                !loading &&
                                    ...
                                    : (
                                        <Link to='/sign-in' className='flex'>
                                            Sign On
                                            <div className='ml-2'>
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-4" viewBox="0 0 20 20" fill="#34790e">
...

                {
                    ...
                    <div className=' hidden container lg:flex px-[10rem] items-center text-[#665522] justify-center'>
                        <div className='flex w-full '>
                            <Link to='/sign-in' className='duration-200 p-4 hover:text-white hover:bg-[#215107]'>Online Banking</Link>
                            <Link to='/sign-in' className='duration-200 p-4 hover:text-white hover:bg-[#215107] whitespace-nowrap'>Credit Cards</Link>
                            <Link to='/sign-in' className='duration-200 p-4 hover:text-white hover:bg-[#215107] whitespace-nowrap'>Checking & Savings</Link>
                            <Link to='/sign-in' className='duration-200 p-4 hover:text-white hover:bg-[#215107]'>Loans</Link>
                        </div>
                        <div className='flex'>
                            <Link to='/register' className='duration-200 p-4  whitespace-nowrap hover:text-white hover:bg-[#215107]'>Request Account</Link>
                            <Link to='/sign-in' className='whitespace-nowrap duration-200 p-4 flex hover:text-white hover:bg-[#215107] text-[#665522] font-semibold'>
                                Sign On
