                                                ...
                                                <div className='flex text-sm items-center'>
                                                    {
                                                        transaction?.status === 'pending' ?
                                                            ...
                                                            />
                                                            :
                                                            <h1 className={'font-semibold text-sm capitalize ' + (transaction.status === 'failed' && 'text-red-500 border-l border-red-600 p-[0.2rem] rounded-sm ') + (transaction?.status === 'complete' && ' text-[#34790e]  border-l border-[#34790e] p-[0.2rem] rounded-sm  ')}>
